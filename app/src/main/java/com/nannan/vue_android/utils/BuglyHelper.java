package com.nannan.vue_android.utils;

import android.content.Context;
import android.os.Environment;

import com.nannan.vue_android.DownLoadActivity;
...
public class BuglyHelper {
     ...
     * 将这里替换为你自己申请的APPID
     */
    public static final String APP_ID = "16bf834c3f";
    ...
    public void initBuglyApp(Context context){
         ...
         */
        Beta.canShowUpgradeActs.add(DownLoadActivity.class);
